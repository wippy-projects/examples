...
<head>
    ...
    <title>Tree-sitter Call Graph</title>
    <style>
...
<body>
    ...
    <script type="module">
        ...
        loadLanguages().then(() => loadGraph());
    </script>
</body>
</html>
]==]

--- GET / — serve the HTML viewer page
